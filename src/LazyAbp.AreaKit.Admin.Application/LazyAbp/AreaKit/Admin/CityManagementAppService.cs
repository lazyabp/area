...
namespace LazyAbp.AreaKit.Admin
{
        ...
        ICityManagementAppService
    {
        ...
        public override async Task<CityDto> CreateAsync(CreateUpdateCityDto input)
        {
            ...
            var city = new City(GuidGenerator.Create(), stateProvince.CountryId, input.StateProvinceId, input.Name, input.DisplayName, input.Abbreviation, input.IsActive, input.DisplayOrder);
        ...
        public override async Task<CityDto> UpdateAsync(Guid id, CreateUpdateCityDto input)
        {
            ...
            city.Update(stateProvince.CountryId, input.StateProvinceId, input.Name, input.DisplayName, input.Abbreviation, input.IsActive, input.DisplayOrder);
        ...
        public override async Task<PagedResultDto<CityDto>> GetListAsync(GetAllCityRequestDto input)
        {
