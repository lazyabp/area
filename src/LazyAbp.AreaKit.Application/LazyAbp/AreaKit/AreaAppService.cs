...
namespace LazyAbp.AreaKit
{
    ...
    public class AreaAppService : ApplicationService, IAreaAppService
    {
        ...
        public AreaAppService(ICountryRepository countryRepository,
        ...
        {
            var list = await _countryRepository.GetListAsync(null, input.Continent, true, input.Filter, input.IncludeDetails);
